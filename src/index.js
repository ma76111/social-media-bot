...
const ADMIN_ONLY_TEXTS = [
  ...
  '👮 إدارة الأدمنز',
  // أزرار إدارة المهام (Reply Keyboard الجديدة)
  '🔙 رجوع', '✏️ تعديل', '🔁 فتح/إغلاق',
  '📝 الحقول', '🎯 الميزات', '🗑 حذف المهمة',
  '📥 التسليمات', '👁 معاينة',
  '✏️ الاسم 🇦🇪', '✏️ Name 🇬🇧',
  '✏️ وصف مختصر 🇦🇪', '✏️ Short desc 🇬🇧',
  '✏️ شرح كامل 🇦🇪', '✏️ Full desc 🇬🇧',
  '💰 المكافأة', '👤 الحد الأقصى', '🔢 الترتيب', '🎥 الفيديو',
  '✅ نعم، احذف',
  '📝 المهام', '📋 المهام',
  '✏️ الاسم عربي', '✏️ Name EN',
  '🔁 النوع', '🔄 إلزامي/اختياري',
  '⬆️ رفع', '⬇️ خفض', '🔀 نوع بديل',
  '🗑 حذف الحقل', '➕ إضافة حقل',
  '🟢 مفتوحة', '🔴 مغلقة',
  '🔴 إجباري', '🟡 اختياري',
  '✅ نعم، أرسل',
